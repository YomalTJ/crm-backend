...
export class Migration1759397479644 implements MigrationInterface {
  name = 'Migration1759397479644';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE `member` (`id` varchar(36) NOT NULL, `name` varchar(255) NOT NULL, `username` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `nic` varchar(255) NOT NULL, `address` varchar(255) NOT NULL, `phoneNumber` varchar(255) NOT NULL, `addedById` varchar(36), PRIMARY KEY (`id`)) ENGINE=InnoDB');
